...
# Load dataset
df = pd.read_csv("Updated Est. Csv.csv")
...
target_col = "Yield (Metric Tons/Ha)"
categorical_cols = [
...
# Define features and target using all columns except the target
...
# Add Accuracy (%) column based on R² Score
...
print(
    "Best model and scaler saved as 'best_regression_model.joblib' and 'scaler.joblib'."
)
